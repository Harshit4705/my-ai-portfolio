export const resumeData = {
    ...
    education: [
        ...
        {
            school: "Maharaja Agrasen Model School, Pitampura",
    ...
    achievements: [
        "Winner, Execute AI Innovation Competition - IITM Janakpuri (March 2025)",
        "1st Place, GenAI Hackathon - IIT Delhi (Jan 2025)",
        "Top 100 Finalist, Execute 4.0 Hackathon - DTU (March 2025)"
    ]
};
